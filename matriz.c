...
#include <stdio.h>
#include <locale.h>
#define INVALIDO "Opção Inválida!, digite uma opção dentre as disponíveis.\n"
...
int main()
{
    ...
    printf("\n");
    printf("A determinante da matriz pode ser calculada de duas maneiras através desse programa, por Laplace ou Sarrus.\n");
    printf("\n");
    printf("Para começar, digite a matriz 3x3 para a qual deseja aplicar as operações.\n");
    ...
    int n=2;
    printf("\n");
    printf("Agora escolha a operação desejada:\n");
    printf("\n");
    ...
    printf("Digite 3 para obter a determinante pelo método de Sarrus.\n");
    printf("Digite 4 para obter a determinante pelo método de Laplace.\n");
    printf("Digite 5 para multiplicar a matriz inserida(principal) por uma matriz 3x3 definida posteriormente.\n");
    printf("Digite 0 para sair do programa e visualizar a matriz formada pelas operações.\n");
    printf("\n");
    while(n>1)
    {
        ...
        if(opcao==2)    //TRANSPOSTA
        {
            ...
            printf("\n");
            printf("Operação de transposição feita!\n");
            for (int linha=0; linha<3; linha++)
            {
                for (int coluna=0; coluna<3; coluna++)
                {
        ...
        if(opcao==3) //SARRUS
        {
            ...
            printf("(Método de Sarrus) O valor da determinante é %d.\n", detsarrus);
            printf("\n");
            printf("Insira a próxima opção...\n");
        }
        if(opcao==4)    //LAPLACE
        {
            ...
            printf("\n");
            printf("Os cofatores de Laplace para a determinante são: %d %d %d.\n", laplace_00, laplace_10, laplace_20);
            printf("(Método de Laplace) O valor da determinante é %d\n", det_laplace);
            printf("\n");
            printf("Insira a próxima opção...\n");
        ...
        {
            printf("\n");
            printf("A matriz resultante das operações feitas é a seguinte:\n");
            for (int linha=0; linha<3; linha++)
            {
                for (int coluna=0; coluna<3; coluna++)
                {
        ...
        if(opcao==1)
        {
            printf("Digite a constante que multiplicará a matriz:\n");
            scanf("%d", &constante);
            for (int linha=0; linha<3; linha++)
            {
                for (int coluna=0; coluna<3; coluna++)
            ...
            printf("\n");
            printf("A multiplicação foi feita, insira a próxima opção.\n");
        }
        ...
        if(opcao==5)
        {
            ...
            printf("\n");
            printf("A matriz gerada pela multiplicação das matrizes inseridas é a seguinte:");
            printf("\n");
            for (int linha=0; linha<3; linha++)
            {
                for (int coluna=0; coluna<3; coluna++)
            ...
            printf("\n");
            printf("Você deseja substituir a matriz principal pela matriz gerada na multiplicação?\n");
            ...
            if(op5==1);
            {
                ...
                printf("A matriz resultante foi definida como principal, escolha a próxima opção de cálculo sobre ela.\n");
                printf("\n");
